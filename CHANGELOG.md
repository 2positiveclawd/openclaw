...
- Agents/OpenAI Responses: sanitize live embedded follow-up turns with orphaned reasoning-block cleanup before function-call pairing downgrade, matching replay-history behavior so stale `rs_*` signatures stop poisoning follow-up context.
